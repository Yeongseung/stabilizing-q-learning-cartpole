...
# Fixed states to observe (threshold: 0.2095 rad)
fixed_states = [
...
for episode in range(3000): # 5000 episodes
    ...
    if np.random.random() < 0.05: # epsilon = 0.05
    ...
    while not game_over:
        ...
        # SARSA: Update both state and action (use next_act in the next step)
        obs = next_obs
        act = next_act
        ...
        if terminated or truncated:
            ...
            # Track Q-values for fixed states
